...
describe('update Hike', () => {
    ...
    test('update array field (like trackPoints) as an adding new Point', async () => {
        ...
        const responseHikeUpdate = new ResponseHelper()
        const newTrackPoints = [[1, 2], [3, 4], [5, 6]]
        const hikeUpdated = await hikeController.updateHike({
            params: {
                id: hike.responseBody._id.toString()
            },
        ...
        for (let i = 0; i < newTrackPoints.length; i++) {
            let trackPoint = hikeUpdated.responseBody.trackPoints[hikeUpdated.responseBody.trackPoints.length - (1 + i)]
    ...
    test('update startPoint', async () => {
        ...
        const startPointUpdated = await Location.findById(hikeUpdated.responseBody.startPoint.toString())
        ...
        expect(startPointUpdated.point[1]).toBe(startPoint.point.lat)
        expect(startPointUpdated.point[0]).toBe(startPoint.point.lng)
