...
const HikerPlannedHikes = () => {
	...
	return (
		<div>
			...
			{!loading && PlannedHikes.length === 0 && <NoData message={"No planned hikes found"} />}
			{!loading &&
...
const HikerActiveHikes = () => {
	...
	return (
		<div>
			...
			{!loading && ActiveHikes.length === 0 && <NoData message="No active hikes found" />}
			{!loading &&
...
const HikerTerminetedHikes = () => {
	...
	return (
		<div>
			...
			{!loading && TerminatedHikes.length === 0 && <NoData message="No completed hikes found" />}
			{!loading &&
