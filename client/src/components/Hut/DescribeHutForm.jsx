				...
				useEffect(() => {
					async function getAltitude() {
						if (
							...
							values.pointLat !== "" &&
							values.pointLng !== "" &&
							values.pointLat !== undefined &&
							values.pointLng !== undefined
						) {
					...
					getAltitude();
				}, [values.pointLat, values.pointLng, setFieldValue, values]);
								...
								<Form.Group controlId="thumbnail" className="mt-3">
									...
									<Form.Control
										...
										onChange={(e) => {
											...
											const thumbnail = document.getElementById("thumbnail-img-hut");
